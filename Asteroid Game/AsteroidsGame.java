...
public class AsteroidsGame
{
     ...
     * arraylists including all elements of the game except for bullets and
     ...
     * updateElements objects. This allows for a polymorphic repesonse where
     * each game element can update itself in its own specialized way. further
     * behaviour information of this method can be found in the update methods
     ...
     * each objects update methods for further documentation of behaviour.
     */
    public void draw()
    {
