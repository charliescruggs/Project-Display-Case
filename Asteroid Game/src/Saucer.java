...
public class Saucer extends Enemy
{
    ...
    /**
     * This method moves a saucer according to its specific behavior of not
    ...
    /**
     * This method overrides update in AnimatedElement, it updates the saucer by calling its override move() method from this class.
     */
    public void update()
    {
        move();
